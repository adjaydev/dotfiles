return {
  ...
  keys = {
    ...
    { '<leader>6', "<cmd>lua require('harpoon.ui').nav_file(6)<cr>", desc = 'Harpoon to file 6' },
    { '<leader>7', "<cmd>lua require('harpoon.ui').nav_file(7)<cr>", desc = 'Harpoon to file 7' },
    { '<leader>8', "<cmd>lua require('harpoon.ui').nav_file(8)<cr>", desc = 'Harpoon to file 8' },
    { '<leader>9', "<cmd>lua require('harpoon.ui').nav_file(9)<cr>", desc = 'Harpoon to file 9' },
  },
}
